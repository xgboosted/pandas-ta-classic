...
from pandas_ta_classic.utils._numba import NUMBA_AVAILABLE, rsx_numba_core
...
def rsx(close, length=None, drift=None, offset=None, **kwargs):
    ...
    use_numba = kwargs.pop("use_numba", True)

    if close is None:
        return

    # Calculate Result using Numba if available
    if NUMBA_AVAILABLE and use_numba:
        # Use Numba-optimized implementation
        result = rsx_numba_core(close.values, length)

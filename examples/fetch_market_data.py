...
``df.ta.ticker()`` / ``ta.yf()`` / ``ta.av()`` helpers were removed after 0.8.32.
Fetch data with the provider library directly and pass the resulting DataFrame
to the library. This file shows the replacement

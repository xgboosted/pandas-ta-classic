...
class TestTrend(TestCase):
    ...
    def test_adx(self):
        ...
        if HAS_TALIB:
            assert_talib(self, result.iloc[:, 0], tal.ADX(self.high, self.low, self.close), correlation_threshold=0.99)
    ...
    def test_aroon_osc(self):
        ...
        if HAS_TALIB:
            assert_talib(self, result.iloc[:, 2], tal.AROONOSC(self.high, self.low), correlation_threshold=0.99)
    ...
    def test_cpr_basic(self):
        assert_indicator_standard(
            ...
            IndicatorSpec(
                ...
                expected_name="CPR",
                expected_type=DataFrame,
                expected_columns=["CPR_TC", "CPR_PIVOT", "CPR_BC", "CPR_WIDTH", "CPR_WIDTH_PCT", "CPR_WIDTH_CLASS", "CPR_POSITION"],
                kwargs={"levels": "basic"},
            ),
        )
    ...
    def test_cpr_classic_standard(self):
        assert_indicator_standard(
            ...
            IndicatorSpec(
                ...
                expected_name="CPR",
                expected_type=DataFrame,
                expected_columns=["CPR_TC", "CPR_PIVOT", "CPR_BC", "CPR_R1", "CPR_R2", "CPR_S1", "CPR_S2", "CPR_WIDTH", "CPR_WIDTH_PCT", "CPR_WIDTH_CLASS", "CPR_POSITION"],
    ...
    def test_cpr_classic_extended(self):
        assert_indicator_standard(
            ...
            IndicatorSpec(
                ...
                expected_name="CPR",
                expected_type=DataFrame,
                expected_columns=["CPR_TC", "CPR_PIVOT", "CPR_BC", "CPR_R1", "CPR_R2", "CPR_S1", "CPR_S2", "CPR_R3", "CPR_R4", "CPR_S3", "CPR_S4", "CPR_WIDTH", "CPR_WIDTH_PCT", "CPR_WIDTH_CLASS", "CPR_POSITION"],
    ...
    def test_cpr_fibonacci(self):
        assert_indicator_standard(
            ...
            IndicatorSpec(
                ...
                expected_name="CPR",
                expected_type=DataFrame,
                expected_columns=["CPR_TC", "CPR_PIVOT", "CPR_BC", "CPR_R1", "CPR_R2", "CPR_S1", "CPR_S2", "CPR_R3", "CPR_S3", "CPR_WIDTH", "CPR_WIDTH_PCT", "CPR_WIDTH_CLASS", "CPR_POSITION"],
    ...
    def test_cpr_virgin_detection(self):
        result = assert_indicator_standard(
            ...
            IndicatorSpec(
                ...
                expected_name="CPR",
                expected_type=DataFrame,
                expected_columns=["CPR_TC", "CPR_PIVOT", "CPR_BC", "CPR_R1", "CPR_R2", "CPR_S1", "CPR_S2", "CPR_WIDTH", "CPR_WIDTH_PCT", "CPR_WIDTH_CLASS", "CPR_POSITION", "CPR_VIRGIN"],
    ...
    def test_dx(self):
        ...
        if HAS_TALIB:
            assert_talib(self, result, tal.DX(self.high, self.low, self.close), correlation_threshold=0.99)
        assert_indicator_standard(self, IndicatorSpec(
            func=pandas_ta.dx,
            args=[self.high, self.low, self.close],
            expected_name="DX_14",
    ...
    def test_minus_dm(self):
        ...
        if HAS_TALIB:
            assert_talib(self, result, tal.MINUS_DM(self.high, self.low), correlation_threshold=0.99)
        assert_indicator_standard(self, IndicatorSpec(
    ...
    def test_plus_dm(self):
        ...
        if HAS_TALIB:
            assert_talib(self, result, tal.PLUS_DM(self.high, self.low), correlation_threshold=0.99)
        assert_indicator_standard(self, IndicatorSpec(
    ...
    def test_psar(self):
        ...
        if HAS_TALIB:
            ...
            assert_talib(self, psar_combined, tal.SAR(self.high, self.low), correlation_threshold=0.99)
        assert_indicator_standard(self, IndicatorSpec(
            func=pandas_ta.psar,
            args=[self.high, self.low],
            expected_name="PSAR_0.02_0.2",
            expected_type=DataFrame,
            expected_columns=["PSARl_0.02_0.2", "PSARs_0.02_0.2", "PSARaf_0.02_0.2", "PSARr_0.02_0.2"],
            none_arg_idx=None,
        ))

...
class TestVolatility(TestCase):
    ...
    def test_aberration(self):
        assert_indicator_standard(self, IndicatorSpec(
            ...
            expected_columns=["ABER_ZG_5_15", "ABER_SG_5_15", "ABER_XG_5_15", "ABER_ATR_5_15"],
            none_arg_idx=None,
        ))
    ...
    def test_atr(self):
        ...
        if HAS_TALIB:
            assert_talib(self, result, tal.ATR(self.high, self.low, self.close), correlation_threshold=0.99)
        assert_indicator_standard(self, IndicatorSpec(
            func=pandas_ta.atr,
            args=[self.high, self.low, self.close],
    ...
    def test_bbands(self):
        ...
        if HAS_TALIB:
            ...
            assert_talib(self, result[["BBL_5_2.0", "BBM_5_2.0", "BBU_5_2.0"]], expecteddf, correlation_threshold=0.99)
        ...
        assert_indicator_standard(self, IndicatorSpec(
            ...
            expected_type=DataFrame,
            expected_columns=["BBL_5_2.0", "BBM_5_2.0", "BBU_5_2.0", "BBB_5_2.0", "BBP_5_2.0"],
        ))
    ...
    def test_natr(self):
        ...
        if HAS_TALIB:
            assert_talib(self, result, tal.NATR(self.high, self.low, self.close), correlation_threshold=0.99)
        assert_indicator_standard(self, IndicatorSpec(
            func=pandas_ta.natr,
            args=[self.high, self.low, self.close],
    ...
    def test_thermo(self):
        assert_indicator_standard(self, IndicatorSpec(
            ...
            expected_type=DataFrame,
            expected_columns=["THERMO_20_2_0.5", "THERMOma_20_2_0.5", "THERMOl_20_2_0.5", "THERMOs_20_2_0.5"],
        ))

    def test_true_range(self):
        result = pandas_ta.true_range(self.high, self.low, self.close, talib=False)
        if HAS_TALIB:
            assert_talib(self, result, tal.TRANGE(self.high, self.low, self.close), correlation_threshold=0.99)
        assert_indicator_standard(self, IndicatorSpec(

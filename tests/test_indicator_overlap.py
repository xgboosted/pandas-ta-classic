...
class TestOverlap(TestCase):
    ...
    def test_tsf(self):
        ...
        pandas_ta.tsf(self.close, talib=False, fillna=0)
        pandas_ta.tsf(self.close, talib=False, fill_method="ffill")
        pandas_ta.tsf(self.close, talib=False, fill_method="bfill")
